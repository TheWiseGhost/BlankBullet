...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 font-sans">
      <h1 className="text-center text-3xl font-mon font-bold mb-4">
        DropFast Privacy Policy
      </h1>
      <p className="text-center mb-6">Effective Date: 01/01/25</p>
      <div className="max-h-[70vh] overflow-y-auto border border-gray-300 rounded-lg p-6 bg-white shadow-lg">
        <p className="mb-4">
          DropFast is committed to protecting your privacy. This Privacy Policy
