...
const CheckoutForm = ({
  ...
  return (
    <div className="flex flex-row space-x-20 bg-white rounded-lg p-6 w-11/12 mx-auto">
      <div className="flex flex-col w-1/2 px-4">
        ...
        />
        <h2 className="text-2xl font-mon font-semibold text-gray-800 text-center my-4">
          {product}
        </h2>
        <div className="w-4/5 mx-auto h-0.5 my-2 bg-gray-300"></div>
        <div className="w-2/3 font-dm mx-auto flex flex-col space-y-2 py-4">
      ...
      <div className="flex flex-col min-w-1/2 px-4">
...
const CheckoutPage = ({ id }) => {
  ...
  return (
    <div className="flex flex-row items-center min-h-screen">
      <div className="w-full px-12 flex flex-col my-20">
        <CheckoutForm
          image={checkoutImg}
