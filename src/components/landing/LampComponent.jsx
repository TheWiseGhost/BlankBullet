  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="-mt-48 font-dm bg-gradient-to-br from-neutral-100 to-neutral-300 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        We Win when
        <br /> You Win
      </motion.h1>
